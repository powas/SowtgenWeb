  ...
  <section>
    <div class="container position-relative z-1">
      <div class="row align-items-center">
        <div class="col-lg-6 pt-5 pt-lg-6">
            <div class="bg-white p-5">
                <h1>Pasteurizadores</h1>
                <p>os equipos pasteurizadores <strong>KommtPaster™</strong> están diseñados para aplicaciones que requieran una gran producción con un bajo costo inicial y operativo.</p>
    ...
    <div class="container fullheight">
      <div class="row">
        ...
        <img src="/img/ingenieria-y-obras-1200x800.jpg" alt="SOWTGEN" title="SOWTGEN" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="row">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="bg-color3 rounded-1 h-100 p-4 ">
                    ...
                    <h5 class="mb-0">Presión</h5>
                    <p>Desde vacío hasta 500 bar</p>
                    <hr class="w-50">
                    <h5 class="mb-0">Temperatura</h5>
                    <p>Desde -164°C hasta 899 °C</p>
                    <hr class="w-50">
            ...
            <div class="col-lg-6">
                <div class="bg-color6 rounded-1 h-100 p-4">
                    <h2>Cualidades</h2>
                    <ul>
